...
export const SettingsModal = ({ display, appSettings }) => {
    ...
    function validateRelayEndpointInput(value) {
        // https://urlregex.com/
    ...
    function validatePriorityFeeInput(value) {
        if (!value)
    ...
    function validateBlocksInFutureInput(value) {
        if (!value)
    ...
    function saveSettings() {
        if (allValidInputs.value) {
            const newSettings = { relayEndpoint: relayEndpointInput.value.value, priorityFee: parseUnits(String(Number(priorityFeeInput.value.value)), 'gwei'), blocksInFuture: BigInt(blocksInFutureInput.value.value) };
